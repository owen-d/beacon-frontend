...
var _user$project$Main$viewBeacon = function (bkn) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(bkn.name),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(bkn.userId),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(bkn.deployName),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$init = {
	...
	_0: A3(
		...
		{ctor: '[]'},
		'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1MTQzOTYzOTksImlhdCI6MTQ5ODg0NDM5OSwidXNlcl9pZCI6IjZiYTdiODEwLTlkYWQtMTFkMS04MGI0LTAwYzA0ZmQ0MzBjOCJ9._Mn0COXwcs9l4NqqAbbosXWCTMentdy4xj9ZqgKhEF0'),
...
var _user$project$Main$Beacon = F3(
	function (a, b, c) {
		return {name: a, userId: b, deployName: c};
	});
var _user$project$Main$decodeBeacons = A2(
	_elm_lang$core$Json_Decode$field,
	'beacons',
	_elm_lang$core$Json_Decode$list(
		A4(
			_elm_lang$core$Json_Decode$map3,
			_user$project$Main$Beacon,
...
var _user$project$Main$fetchBeacons = function (jwt) {
	var url = 'http://localhost:8080/beacons/';
	return A2(
...
var _user$project$Main$FetchBeacons = {ctor: 'FetchBeacons'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$FetchBeacons),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('fetch beacons'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_user$project$Main$viewBeacon,
						_elm_lang$core$List$reverse(model.beacons))),
				_1: {ctor: '[]'}
			}
		});
};
